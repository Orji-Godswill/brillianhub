        ...
        def clean(self):
          ...
          if qs.exists():
              ...
              if not_active.exists():
                  ...
                  email_confirm_exists = EmailActivation.objects.email_exists(email)
...
class ContactForm(forms.ModelForm):
    class Meta:
        model = Contact
        fields = ('name', 'subject', 'sender', 'phone', 'message', 'cc_myself')
        widgets = {
                    ...
                    'sender': forms.EmailInput(attrs={"class": "form-control","placeholder": "Enter a valid email address"}),
